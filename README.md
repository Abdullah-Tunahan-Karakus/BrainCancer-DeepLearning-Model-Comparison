...
> **⚠️ Duplicate Data Temizliği:** EDA aşamasında `brain_tumor` sınıfında veri sızıntısına (data leakage) yol açabilecek 44 adet kopya (duplicate) görüntü tespit edilmiş ve özel bir algoritma ile silinmiştir.Böylece veri seti boyutu 6056'dan 6012'ye düşürülerek modelin özgün veriyle eğitilmesi garanti altına alınmıştır.
